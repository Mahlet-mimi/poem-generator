...
function poemGenerate(event) {
  ...
  let context =
    "Your mission is to generate very short poem only 4 lines and separate each lines in <br \> and sign in with 'SheCodes AI' with <strong> element not in the beginning but the bottom of that poem";
